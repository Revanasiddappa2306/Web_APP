...
const [field_9, setfield_9] = React.useState("");
  ...
  React.useEffect(() => {
    fetch("http://localhost:5000/api/tables/get-table-data", {
      ...
      body: JSON.stringify({ tableName: "F10page_Table" })
    })
      .then(res => res.json())
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100 text-gray-900">
      ...
      <main className="flex-1 p-6 flex flex-col items-center justify-center">
        <h1 className="text-2xl font-bold mb-6 text-center">F10page</h1>
  ...
  {/* Left: Empty (or add something if needed) */}
  ...
  <table className="max-w-full bg-white border border-gray-300 shadow" style={{ minWidth: "1860px" }}>
    <thead>
      <tr>
