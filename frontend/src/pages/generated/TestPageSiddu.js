...
const [field_3, setfield_3] = React.useState("");
  ...
  React.useEffect(() => {
    fetch("http://localhost:5000/api/tables/get-table-data", {
      ...
      body: JSON.stringify({ tableName: "TestPageSiddu_Table" })
    })
      .then(res => res.json())
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100 text-gray-900">
      ...
      <main className="flex-1 p-6 flex flex-col items-center justify-start w-full">
        <h1 className="text-2xl font-bold mb-6 text-center">TestPageSiddu</h1>
            ...
            <table className="table-auto bg-white border border-gray-300 shadow mx-auto">
              <thead>
                <tr>
                  ...
                  <th className="p-2 border-b border-r min-w-[120px] w-[120px]">Select Date</th><th className="p-2 border-b border-r min-w-[100px] w-[100px]">Shift</th><th className="p-2 border-b border-r min-w-[160px] w-[160px]">Enter Name</th><th className="p-2 border-b border-r min-w-[160px] w-[160px]">Enter Department</th>
                </tr>
              </thead>
              <tbody>
                {filteredTableData.map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="p-2 border-b border-r min-w-[120px] w-[120px]">{row["Select_Date"] ? new Date(row["Select_Date"]).toLocaleDateString() : ""}</td><td className="p-2 border-b border-r min-w-[100px] w-[100px]">{row["Shift"]}</td><td className="p-2 border-b border-r min-w-[160px] w-[160px]">{row["Enter_Name"]}</td><td className="p-2 border-b border-r min-w-[160px] w-[160px]">{row["Enter_Department"]}</td>
                  </tr>
                ))}
              </tbody>
            </table>
