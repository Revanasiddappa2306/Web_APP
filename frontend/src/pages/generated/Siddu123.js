  ...
  const GeneratedForm = () => {
    ...
    React.useEffect(() => {
      fetch("http://localhost:5000/api/tables/get-table-data", {
        ...
        body: JSON.stringify({ tableName: "Siddu123_Table" })
      })
        .then(res => res.json())
    ...
    return (
      <div className="flex flex-col min-h-screen bg-gray-100 text-gray-900">
        ...
        <main className="flex-1 p-6 flex flex-col items-center justify-start w-full">
          <h1 className="text-2xl font-bold mb-6 text-center">Siddu123</h1>
              ...
              <table className="table-auto bg-white border border-gray-300 shadow mx-auto">
                <thead>
                  <tr>
                    ...
                    <th className="p-2 border-b border-r min-w-[160px] w-[160px]">Name</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredTableData.map((row, idx) => (
                    ...
                    >
                      ...
                      <td className="p-2 border-b border-r min-w-[160px] w-[160px]">{row["Name"]}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
